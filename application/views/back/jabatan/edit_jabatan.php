          ...
          <?= validation_errors();?>
            <form action="<?= base_url('jabatan/update_jabatan')?>" method="POST">
                <div class="form-group">
                  <label> Jabatan </label>
                  <input type="hidden" name="id_jabatan" value="<?= $jbt->id_jabatan ?>"class="form-control"></input>
                  <input type="text" name="jabatan" value="<?= $jbt->jabatan ?>"class="form-control"></input>
                </div>
